...
def load_hotpotqa_questions(json_path: str, limit: int | None = None) -> list[dict]:
...
def main() -> None:
    ...
    parser.add_argument("--limit", type=int, default=100, help="测试问题数量")
    parser.add_argument("--output", type=str, default="./data/experiment_results.csv", help="输出 CSV 路径")
    parser.add_argument("--data", type=str, default="./data/hotpotqa_dev.json", help="HotpotQA JSON 路径")
    args = parser.parse_args()

    print(f"📂 加载数据: {args.data}")
    dataset = load_hotpotqa_questions(args.data, limit=args.limit)
